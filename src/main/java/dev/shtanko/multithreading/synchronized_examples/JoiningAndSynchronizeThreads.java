package dev.shtanko.multithreading.synchronized_examples;
...
public class JoiningAndSynchronizeThreads {
     ...
     * synchronized keyword count variable will vary that it is not atomic in
    ...
    public void doWork() {
            ...
            public void run() {
                for (int i = 0; i < 10_000; i++) {
                    try {
                        ...
                        Logger.getLogger(JoiningAndSynchronizeThreads.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        });
         ...
         * Reminder: your method is also a thread so without joining
